...
namespace NZWalks.UI.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> Add(AddRegionViewModel model)
        {
            ...
            var httpRequesetMessage = new HttpRequestMessage()
            {
            ...
            var httpResponseMessage = await client.SendAsync(httpRequesetMessage);
        ...
        public async Task<IActionResult> Edit(Guid id)
        {
            ...
            var response = await client.GetFromJsonAsync<RegionDto>($"https://localhost:7266/api/regions/{id.ToString()}");
